...
export function CourseCreateForm({ loading, onSubmit }: Props) {
      ...
      <div className="flex justify-center h-fit pe-4 w-90">
        <div className="px-[120px] py-12 pb-20 border-2 shadow-xl rounded-2xl w-full bg-white h-full">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-gray-800">Tạo khoá học</h1>
            <p className="text-gray-500">
              Hoàn thành các thông tin dưới đây để tạo khoá học mới
            </p>
          </div>
